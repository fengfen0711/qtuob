<template>
	<div class="background">
		...
		<div class="content">
			...
			<div class="plan">
				...
				<p class="item item1" ref="item1">
					<img class="point" src="images/point.png"></img>
		...
		<Popup v-show="seen" :prodNo="prodNo"></Popup>
	</div>
</template>
...
<script>
	...
	export default {
    	...
    	created(){
    		...
    		if (this.$route.query.prodCode == "P000303010194" || this.$route.query.prodCode == "P000018000001") {
    			this.seen = true
    		}
    	},
    	methods:{
