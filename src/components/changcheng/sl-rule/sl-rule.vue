<template>
	<div>
        ...
        <div id="ruler-container" ref="ruleclass" class="ruler-container">
            ...
            <div id="ruler" ref="ruler" class="ruler" data-offset="0" @touchstart="rulertouchstart">
                <ul id="ruler-ul" class="ruler-ul" @touchmove="rulerUltouchmove">
