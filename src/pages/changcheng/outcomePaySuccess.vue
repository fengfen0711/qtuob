<template>
	<div class="recepit_all">
		<div>
			...
			<p class="result_gener">内容详情，根据实际文案安排</p>
			...
			<div class="feedpay_div">
				...
				<p class="feed_div_p1">
					...
					<span class="feed_number">10000.00</span>
