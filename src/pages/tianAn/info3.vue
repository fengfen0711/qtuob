		...
		<div class="twoCon">
			<div class="twoCon2" :class="{borderNone:policyHolderShow}">
				...
				<p class="inputGrop clearFloat">
					<img src="/static/img/noSelected.png" class="btnImg" v-show="!policyHolderShow" @click="policyHolderShowHide()" />
					<img src="/static/img/selected.png" class="btnImg" v-show="policyHolderShow" @click="policyHolderShowHide()" />
...
<script>
	import Beneficiary from './taBeneficiary.vue'
