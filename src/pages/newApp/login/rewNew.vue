	...
	<div class="regBox">
		...
		<div class="inputBox">
			...
			<p class="inputGrop clearFloat" v-show="eyeShow">
				<span class="inputLabel"></span>
				<input type="password" maxlength="12" class="inputText" v-model="passWord" @keyup.13=handleClickRegister() placeholder="请输入密码（6-12位数字和字母）" />
				<img src="/static/imgNew/eye_open3.png" class="eyeBtn" @click="eyeClick" />
			</p>
			<p class="inputGrop clearFloat" v-show="!eyeShow">
				<span class="inputLabel"></span>
				<input type="text" maxlength="12" class="inputText" v-model="passWord" @keyup.13=handleClickRegister() placeholder="请输入密码（6-12位数字和字母）" />
				<img src="/static/imgNew/eye_close3.png" class="eyeBtn" @click="eyeClick" />
			</p>
			<div class="btnBox">
				<span class="nextBtn" @click="handleClickRegister">确定</span>
			</div>
