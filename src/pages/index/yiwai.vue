	...
	<div class="bg">
		...
		<div class="tab">
			...
			<div @click="handleClickTable(3)" style="border-left:1px solid #ccc ;box-sizing: border-box;" class="item" :class="{active:item3}">
				<p class="list">E款</p>
				<p class="tab_money">&yen;938元起</p>
			</div>
		</div>
		<div class="content">
			<p class="title">保险责任 <span class="lipei">新华保险承保并负责理赔</span></p>
			<p class="title title1">意外伤害保险 <span class="lipei lipei1">{{money1}}</span></p>
			<p class="title title1">并发症保险 <span class="lipei lipei1">{{money2}}（单项责任5000元为限）</span></p>
			<p class="title2">手术类型
				<span class="cla" :class="{claActive:show}"  @click="handleClickCla">住院手术</span>
				<span class="cla" :class="{claActive:!show}"  @click="handleClickCla">门诊手术</span>
			</p>
			<p class="title2">保额
